...
public class TestCreeperEntityRenderer extends MobRenderer {
	...
	protected void applyScale(MobEntity entity, float f) {
	...
	protected int getOverlayColor(MobEntity entity, float f, float g) {
		TestCreeperEntity creeperEntity = (TestCreeperEntity) entity;
	...
	protected int bindDecorationTexture(MobEntity entity, int i, float f) {
		return -1;
	}
}
