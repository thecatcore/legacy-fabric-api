...
public class TestCreeperEntityRenderer extends MobRenderer<TestCreeperEntity> {
	...
	protected int bindTexture(TestCreeperEntity creeperEntity, int i, float f) {
	...
	protected int bindDecorationTexture(TestCreeperEntity creeperEntity, int i, float f) {
		return -1;
	}

	@Override
	protected Identifier getTextureLocation(TestCreeperEntity entity) {
		return TEXTURE;
	}
}
