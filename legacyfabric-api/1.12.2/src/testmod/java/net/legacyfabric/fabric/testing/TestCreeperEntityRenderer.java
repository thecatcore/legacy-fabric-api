...
public class TestCreeperEntityRenderer extends MobEntityRenderer<TestMod.TestCreeperEntity> {
...
//		this.addFeature(new CreeperLightningFeatureRenderer(this));
	...
	protected void scale(TestMod.TestCreeperEntity creeperEntity, float f) {
	...
	protected int method_5776(TestMod.TestCreeperEntity creeperEntity, float f, float g) {
	...
	protected Identifier getTexture(TestMod.TestCreeperEntity creeperEntity) {
		return TEXTURE;
	}
}
